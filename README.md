...
```gradle
compile 'com.github.ben-manes.caffeine:caffeine:2.8.7'

// Optional extensions
compile 'com.github.ben-manes.caffeine:guava:2.8.7'
compile 'com.github.ben-manes.caffeine:jcache:2.8.7'
```
