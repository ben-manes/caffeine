...
/**
 * A generator of an exponential distribution. It produces a sequence of time intervals (integers)
 * according to an exponential distribution. Smaller intervals are more frequent than larger ones,
 * and there is no bound on the length of an interval. When you construct an instance of this class,
 * you specify a parameter gamma, which corresponds to the rate at which events occur.
