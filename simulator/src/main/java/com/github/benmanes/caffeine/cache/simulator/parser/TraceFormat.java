...
import com.github.benmanes.caffeine.cache.simulator.parser.snia.systor.SystorTraceLatencyReader;
import com.github.benmanes.caffeine.cache.simulator.parser.snia.systor.SystorTraceSizeReader;
...
public enum TraceFormat {
  ...
  SNIA_SYSTOR_SIZE(SystorTraceSizeReader::new),
  SNIA_SYSTOR_LATENCY(SystorTraceLatencyReader::new),
