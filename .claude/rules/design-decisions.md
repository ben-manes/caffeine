...
- **Catch-commit-rethrow** in doComputeIfAbsent/remap makes phantom evictions real on exception. Instead verify the committed state is consistent.
- **Two weight fields** (weight + policyWeight) is intentional for the telescoping sum. Instead verify both fields converge.
