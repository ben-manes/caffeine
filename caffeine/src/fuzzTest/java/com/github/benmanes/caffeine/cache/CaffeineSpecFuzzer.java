...
final class CaffeineSpecFuzzer {
  ...
  private static void checkKeyStrength(Options options, CaffeineSpec spec, Caffeine<?, ?> builder) {
  ...
  private static void checkMaximumWeight(Options options, CaffeineSpec spec, Policy<?, ?> policy) {
    if (options.maximumWeight == null) {
