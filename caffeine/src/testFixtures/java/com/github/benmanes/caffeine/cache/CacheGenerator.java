...
public final class CacheGenerator {
  ...
  private Set<List<Object>> combinations() {
    @Var var asyncLoader = ImmutableSet.of(true, false);
    var keys = filterTypes(options.keys(), cacheSpec.keys());
    var statistics = filterTypes(options.stats(), cacheSpec.stats());
    @Var var values = filterTypes(options.values(), cacheSpec.values());
    ...
    @Var var implementations = filterTypes(options.implementation(), cacheSpec.implementation());
