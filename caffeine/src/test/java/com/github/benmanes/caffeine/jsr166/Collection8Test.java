    ...
    public void testRemoveIf() {
        ...
        try {
            ...
            if (it != null && impl.isConcurrent()) {
              ...
              while (it.hasNext()) {
                assertTrue(orig.contains(it.next()));
              }
            }
    ...
    public void testRandomElementRemovalDuringTraversal() {
        ...
        if (rnd.nextBoolean()) {
            ...
            Predicate randomlyRemove = e -> {
                if (rnd.nextBoolean()) { removed.add(e); return true; } else {
                  return false;
                }
            };
