 ...
 */
@Test
@SuppressWarnings({"ClassNamedLikeTypeParameter", "EmptyCatch", "InterruptedExceptionSwallowed",
    "InvalidBlockTag", "rawtypes", "StreamOfArray", "SystemOut", "UnnecessaryFinal",
    "YodaCondition"})
