 ...
 *
 * <p>A {@link Set} projection of a ConcurrentHashMap2 may be created
 * (using {@link #newKeySet()} or {@link #newKeySet(int)}), or viewed
 * (using {@link #keySet(Object)} when only keys are of interest, and the
 * mapped values are (perhaps transiently) not used or all take the
 * same mapping value.
 *
 * <p>A ConcurrentHashMap2 can be used as scalable frequency map (a
 * form of histogram or multiset) by using {@link
 * java.util.concurrent.atomic.LongAdder} values and initializing via
 * {@link #computeIfAbsent computeIfAbsent}. For example, to add a count
 * to a {@code ConcurrentHashMap2<String,LongAdder> freqs}, you can use
 ...
 *
 * <p>ConcurrentHashMap2s support a set of sequential and parallel bulk
 ...
 * and/or return values. Because the elements of a ConcurrentHashMap2
 ...
 * from those of ConcurrentHashMap2: Any non-null result returned
...
//        }
    ...
    abstract static class CollectionView<K,V,E>
        ...
        private static final long serialVersionUID = 7249069246763182397L;
        final ConcurrentHashMap2<K,V> map;
        CollectionView(ConcurrentHashMap2<K,V> map)  { this.map = map; }
         ...
         */
        public ConcurrentHashMap2<K,V> getMap() { return map; }
    ...
    static final class ValuesView<K,V> extends CollectionView<K,V,V>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        ValuesView(ConcurrentHashMap2<K,V> map) { super(map); }
        @Override
    ...
    static final class EntrySetView<K,V> extends CollectionView<K,V,Map.Entry<K,V>>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        EntrySetView(ConcurrentHashMap2<K,V> map) { super(map); }
